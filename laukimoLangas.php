    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo "<a href='/atsaukti.php?name=" . htmlspecialchars($_GET['vard']) . "&regtime=" . htmlspecialchars($_GET['regtime']) . "&specialistas=" . htmlspecialchars($_GET['spec']) . "' class='btn btn-default' value='Atšaukimas'"; ?></td>
                <td></td>
            </tr>
        </tbody>
    </table>
