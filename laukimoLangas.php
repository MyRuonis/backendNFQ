    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo '<form action="/delPat.php?name=' . $_GET['vard'] . '&regtime=' . $_GET['regtime'] . '&specialistas=' . $_GET['spec'] . '&page=none" method="get"><input type="submit" value="Atšaukti" ></form>';?></td>
            </tr>
        </tbody>
    </table>
</div>
